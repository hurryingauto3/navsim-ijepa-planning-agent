...
def transfuser_loss(
    ...
    """
    Compute all TransFuser loss terms and return a dict suitable for logging.

    Returns:
        {
            "loss": <total loss tensor w/ grad>,
            "trajectory_loss": <no grad>,
            "agent_class_loss": <no grad>,
            "agent_box_loss": <no grad>,
            "bev_semantic_loss": <no grad>,
        }
    """
    ...
    # weighted sum (this is what we actually backprop)
    total_loss = (
    ...
    # return dict for lightning
    return {
        "loss": total_loss,  # keep gradient here
        "trajectory_loss": trajectory_loss.detach(),
        "agent_class_loss": agent_class_loss.detach(),
        "agent_box_loss": agent_box_loss.detach(),
        "bev_semantic_loss": bev_semantic_loss.detach(),
    }
