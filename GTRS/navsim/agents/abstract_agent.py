...
class AbstractAgent(torch.nn.Module, ABC):
    ...
    def compute_trajectory(self, agent_input: AgentInput) -> Trajectory:
        ...
        # add batch dimension
        # Handle both tensors and lists (some feature builders return lists)
        features = {
        ...
        with torch.no_grad():
            ...
            trajectory_tensor = predictions["trajectory"].squeeze(0)
            if trajectory_tensor.is_cuda:
                trajectory_tensor = trajectory_tensor.cpu()
