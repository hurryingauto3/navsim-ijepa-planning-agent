...
CACHE_DIR="${NAVSIM_EXP_ROOT}/cache_${AGENT_CONFIG_NAME}_${SPLIT_NAME}_10pct"
# Number of training epochs
MAX_EPOCHS=30 # Or your desired number
# Experiment name for training logs and checkpoints
EXP_NAME="train_${AGENT_CONFIG_NAME}_${SPLIT_NAME}_10pct"
...
# --- Command ---
echo "Starting Training for ${SPLIT_NAME} (10% of cached data)..."
...
python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_training.py \
    ...
    trainer.strategy=auto # Or ddp if multi-GPU/node
